...
def main(config):
    ...
    # freeze first 5 layers of discriminator
    for i in range(6):
        for param in discriminator.net[i].parameters():
    ...
    # print(f"First {args['freeze']} layers of discriminator are frozen.")
    print("First 5 layers of discriminator are frozen.")
...
if __name__ == '__main__':
    ...
    args.add_argument('-f', '--freeze', default=5, type=int, 
                      help='number of layers to freeze in discriminator')
    """
